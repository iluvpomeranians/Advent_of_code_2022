...
for (my $idx = 10; $idx <= $#arr_1; $idx++){
    ...
    for (my $idx_1 = 0; $idx_1 < $move; $idx_1++){
        
    switch($from) {
        case 1          {  $popped_elements[$idx_1] = pop(@stack_one);     }
        case 2          {  $popped_elements[$idx_1] = pop(@stack_two);     }
        case 3          {  $popped_elements[$idx_1] = pop(@stack_three);   }
        case 4          {  $popped_elements[$idx_1] = pop(@stack_four);    }
        case 5          {  $popped_elements[$idx_1] = pop(@stack_five);    }
        case 6          {  $popped_elements[$idx_1] = pop(@stack_six);     }
        case 7          {  $popped_elements[$idx_1] = pop(@stack_seven);   }
        case 8          {  $popped_elements[$idx_1] = pop(@stack_eight);   }
        case 9          {  $popped_elements[$idx_1] = pop(@stack_nine);    }  
        else            { print "Not a valid letter/option\n"     }
        }

    }

    for (my $idx_2 = ($move - 1); $idx_2 >= 0 ; $idx_2--){

    switch($to) {
        case 1          { push(@stack_one, $popped_elements[$idx_2]);      }
        case 2          { push(@stack_two, $popped_elements[$idx_2]);      }
        case 3          { push(@stack_three, $popped_elements[$idx_2]);    }
        case 4          { push(@stack_four, $popped_elements[$idx_2]);     }
        case 5          { push(@stack_five, $popped_elements[$idx_2]);     }
        case 6          { push(@stack_six, $popped_elements[$idx_2]);      }
        case 7          { push(@stack_seven, $popped_elements[$idx_2]);    }
        case 8          { push(@stack_eight, $popped_elements[$idx_2]);    }
        case 9          { push(@stack_nine, $popped_elements[$idx_2]);     }
        else            { print "Not a valid letter/option\n"     } 
        }
